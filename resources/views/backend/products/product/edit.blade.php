            ...
            <x-slot name="body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col">
                        ...
                        <input type="text" name="category" id="category" placeholder="category" value="{{ $product->category }}" class="form-control" />
                    </div>
                    ...
                    <div class="form-group col">
                        ...
                        <input type="text" name="rate" id="rate" placeholder="rate" value="{{ $product->rate }}" class="form-control" />
                    </div>
                </div>
