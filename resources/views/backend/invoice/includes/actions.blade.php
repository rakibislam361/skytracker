<div class="btn-group" role="group" aria-label="@lang('labels.backend.access.users.user_actions')">
    <div class="btn-group btn-group-sm" role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="userActions">
            ...
            {{-- @endif --}}
            <a href="{{ route('admin.invoice.details', $invoice) }}"
                class="dropdown-item show_details">@lang('Details')</a>
            ...
            @if ($logged_in_user->isAdmin())
                <a href="{{ route('admin.invoice.destroy', $invoice) }}" data-method="delete"
                    class="dropdown-item text-danger" data-trans-title="@lang('Do you want to delete?')"
                    data-trans-button-confirm="@lang('Delete')" data-trans-button-cancel="@lang('Cancel')">
                    @lang('Delete')
                </a>
            @endif
