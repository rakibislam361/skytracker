            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
              ...
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link" :text="__('Color Settings')" />
                ...
                <ul class="nav nav-treeview">
                    ...
                    @if ($logged_in_user->hasAllAccess())
                        <li class="nav-item">
                            <x-utils.link :href="route('admin.auth.user.deleted')" icon="nav-icon fas fa-user" class="nav-link"
                                :text="__('Deleted Users')" :active="activeClass(Route::is('admin.auth.role.*'))" />
                        </li>
                    @endif
                </ul>
                </li>
