            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <x-utils.link :href="route('admin.order.local')" icon="nav-icon icon-arrow-right" class="nav-link" :text="__('Local Product')" />
                ...
                <li class="nav-item {{ activeClass(Route::is('admin.booking.*'), 'menu-open') }}">
                    <x-utils.link-sidebar href="#" :text="__('Local Booking')" icon="nav-icon icon-star" class="nav-link" rightIcon="fas fa-angle-left right" />
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <x-utils.link :href="route('admin.booking.index')" icon="nav-icon icon-arrow-right" class="nav-link" :text="__('Booking Order')" />
                        </li>
                        <li class="nav-item">
                            <x-utils.link :href="route('admin.invoice.index')" icon="nav-icon icon-arrow-right" class="nav-link" :text="__('Invoice')" />
                        </li>
                    </ul>
                </li>
                @endif
