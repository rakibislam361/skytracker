...
<aside class="main-sidebar sidebar-light-cyan elevation-3">
  ...
  <a href="{{route('admin.dashboard')}}" class="brand-link">
    <img src="{{asset('img/essential/admin.png')}}" alt="{{appName()}}" class="brand-image img-circle elevation-3"
      style="opacity: .8">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <x-utils.link-sidebar :href="route('admin.dashboard')" :text="__('Dashboard')"
            icon="nav-icon icon-speedometer" :active="activeClass(Route::is('admin.dashboard'), 'menu-open')"
            class="nav-link" />
        </li>

        <li class="nav-item {{ activeClass(Route::is('admin.product.*'), 'menu-open') }}">
          <x-utils.link-sidebar href="#" :text="__('Products')" icon="nav-icon icon-star" class="nav-link"
            rightIcon="fas fa-angle-left right" :active="activeClass(Route::is('admin.product.*'))" />
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <x-utils.link :href="route('admin.product.brand.index')" 
              icon="nav-icon icon-arrow-right" 
              :active="activeClass(Route::is('admin.product.brand.*'))"
              class="nav-link" :text="__('Brand')" />
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
                :text="__('Sub Subcategory')" />
            </li>
            <li class="nav-item">
              <x-utils.link :href="route('admin.product.inhouse.index')" icon="nav-icon icon-arrow-right"
                class="nav-link" :active="activeClass(Route::is('admin.product.inhouse.*'))"
                :text="__('In House Products')" />
            </li>
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
                :text="__('Seller Products')" />
            </li>
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
                :text="__('Bulk Import')" />
        ...
        <li class="nav-item">
          <x-utils.link-sidebar :href="route('admin.page.index')" :text="__('Manage Page')"
            :active="activeClass(Route::is('admin.page.*'))" icon="nav-icon fas fa-file-word" class="nav-link" />
        </li>

        <li class="nav-item {{ activeClass(Route::is('admin.messaging.*'), 'menu-open') }}">
          <x-utils.link-sidebar href="#" :text="__('Messaging')" icon="nav-icon icon-envelope" class="nav-link"
            rightIcon="fas fa-angle-left right" />
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <x-utils.link :href="route('admin.messaging.contact.index')"
                :active="activeClass(Route::is('admin.messaging.contact.*'))" icon="nav-icon icon-arrow-right"
                class="nav-link" :text="__('Cotacts')" />
            </li>
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
                :text="__('Newsletters')" />
        ...
        <li class="nav-item">
          <x-utils.link-sidebar href="#" :text="__('Business Settings')" icon="nav-icon icon-star" class="nav-link"
            rightIcon="fas fa-angle-left right" />
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
            ...
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
                :text="__('SMTP Settings')" />
            </li>
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
                :text="__('Google Analytics')" />
            </li>
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
                :text="__('Facebook Chat & Pixel')" />
            </li>
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
                :text="__('Social Login')" />
            </li>
            <li class="nav-item">
        ...
        <li class="nav-item">
          <x-utils.link-sidebar href="#" :text="__('Frontend Settings')" icon="nav-icon icon-star" class="nav-link"
            rightIcon="fas fa-angle-left right" />
          <ul class="nav nav-treeview">
            <li class="nav-item">
            ...
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
                :text="__('Logo Settings')" />
            </li>
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
                :text="__('Color Settings')" />
            </li>
          </ul>
        </li>

        <li class="nav-item">
          <x-utils.link-sidebar href="#" :text="__('E-commerce Setup')" icon="nav-icon icon-star" class="nav-link"
            rightIcon="fas fa-angle-left right" />
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <x-utils.link :href="url('#')" icon="nav-icon icon-arrow-right" class="nav-link"
