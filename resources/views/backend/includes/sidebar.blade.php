            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <x-utils.link-sidebar :href="route('admin.dashboard')" :text="__('Dashboard')" icon="nav-icon icon-speedometer"
                        :active="activeClass(Route::is('admin.dashboard'), 'menu-open')" class="nav-link" />
                </li>
                {{-- order --}}
                ...
                @if ($logged_in_user->hasAllAccess())
                    <li class="nav-item {{ activeClass(Route::is('admin.product.*'), 'menu-open') }}">
                        <x-utils.link-sidebar href="#" :text="__('Accounts')" icon="nav-icon icon-star"
                            class="nav-link" rightIcon="fas fa-angle-left right" :active="activeClass(Route::is('admin.product.*'))" />
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
