                                ...
                                <tbody>
                                    ...
                                    <tr id="{{ $item->id }}">
                                        ...
                                        <td class="text-left" colspan="3">
                                            ...
                                            <a href="https://www.skybuybd.com{{ $item->link }}" class="ml-3" target="_blank">
                                            ...
                                            <button class="order-item-modal btn btn-link" data-value="{{ $item->id }}">Purchase Item</button>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left align-middle">
                                            ...
                                            @endphp
                                            @if ($loop->first)
                                            <p class="m-0">{!! $PropertyName !!}: <span class="ml-2">{!! $Value !!}</span>
                                            </p>
                                            <p class="m-0">
                                                Unit Price:
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <td class="text-right">
                                        ...
                                        <form action="{{ route('admin.order.coupon.update', $order->id) }}" method="post" class="d-inline-block" style="max-width:100px;">
                                            @csrf
                                ...
                                <tr>
                                    <td class="text-right">
                                        ...
                                        @if ($order->status == 'on-hold')
                                        <form action="{{ route('admin.order.deposit.update', $order->id) }}" method="post" class="d-inline-block" style="max-width:100px;">
                                            @csrf
                                            <input type="hidden" name="order_item_id" id="order_item_id" value={{ $order->id }} class="form-control" />
