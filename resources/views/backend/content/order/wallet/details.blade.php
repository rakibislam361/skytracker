            ...
            <div class="card">
                <div class="card-header clearfix">
                    ...
                    <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
                        <a href="{{ route('admin.order.wallet') }}" onClick="window.close();" class="btn btn-primary"
                            data-toggle="tooltip" title="Back Orders">
                            ...
                            <tbody>
                                        ...
                                        @else
                                            <tr>
                                                <td class="text-capitalize align-middle  text-center">
                                                    {!! $PropertyName !!}</td>
                                                <td class=" text-center text-break" style="max-width: 120px">
                                                    {{ $Value }}</td>
                                            </tr>
                                        @endif
                                    @empty
                                ...
                                <tr>
                                    <td class=" text-right" colspan="5">
                                        Shipping Charge (+) <span class="text-danger">(Shipping Rate X Actual weight)</span>
                                        <br>
                                        {{ $order->shipped_by . ' - ' . $currency . ' ' . floating($order->shipping_rate) }}
                                        X
                                ...
                                @if ($order->coupon_contribution)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ $currency . ' ' . floating($order->coupon_contribution) }}
                                        </td>
                                    </tr>
                                @endif
