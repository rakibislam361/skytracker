    ...
    <div class="row">
        ...
        <div class="co-4">
            ...
            <select class="form-control" name="status">
                ...
                @if ($logged_in_user->can('admin.order.order_rmb.edit') ||$logged_in_user->can('admin.order.purchase.edit')||$logged_in_user->can('admin.order.status.edit')||$logged_in_user->can('admin.order.rate.edit'))
                <option @if (request('status', null)=='processing' ) selected @endif value="processing">Processing</option>
                @endif

                @if ($logged_in_user->can('admin.order.purchase.edit')||$logged_in_user->can('admin.order.status.edit')||$logged_in_user->can('admin.order.rate.edit'))
