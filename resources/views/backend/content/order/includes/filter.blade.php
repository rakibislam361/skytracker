<form name="search" action="{{ route('admin.order.index') }}" method="GET">
    <div class="row">
        ...
        <div class="col-md-1">
            ...
            <input type="text" id="carton_id" name="carton_id" class="form-control" value="{{ request('carton_id', null) }}" placeholder="Carton Id">
        </div>
        <div class="col-md-2">
            <label for="customer">Name/Phone</label>
            <input type="text" id="customer" name="customer" class="form-control" value="{{ request('customer', null) }}" placeholder="Name/Phone">
        </div>
