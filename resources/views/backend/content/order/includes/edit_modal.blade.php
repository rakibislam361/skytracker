            ...
            <form method="post" action="{{ route('admin.order-update') }}" id="statusChargeForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="order_item_number" id="order_item_number" placeholder="item number"
                    ...
                    @if ($logged_in_user->hasAllAccess())
                        <div class="form-group">
                            ...
                            <input type="text" name="product_value" placeholder="Product price from Skybuy"
                                class="form-control" />
                        </div>

                        <div class="form-group">
                            <label for="product_bd_received_coast">BD Received Cost</label> {{-- calculate product cost + china local delivery --}}
                            <input type="text" name="product_bd_received_coast"
                                placeholder="(china local delivery*Conversion)+product Cost" class="form-control" />
                        </div>
                    @endif
                    ...
                    @if ($logged_in_user->hasAllAccess() || $logged_in_user->can('admin.order.localdelivery.edit'))
                        <div class="form-group">
                            ...
                            <input type="text" name="chinaLocalDelivery" placeholder="China Local Delivery"
                                class="form-control" />
                        </div>
                    @endif
                    ...
                    @if ($logged_in_user->hasAllAccess() || $logged_in_user->can('admin.order.carton.edit'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="chn_warehouse_qty" placeholder="chn_warehouse_qty"
                                class="form-control" />
                        </div>

                        <div class="form-group">
                            <label for="chn_warehouse_weight">Chn Warehouse Weight</label>
                            <input type="text" name="chn_warehouse_weight" placeholder="chn_warehouse_weight"
                                class="form-control" />
                        </div>
