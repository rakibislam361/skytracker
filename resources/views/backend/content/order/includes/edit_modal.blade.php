        ...
        <div class="modal-content">
            <form method="post" id="updateItem">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="purchase_cost_bd">BD Out<small class="form-text text-muted float-right">(Purchase Rmb * Conversion
                                Rate)</small></label>
                    ...
                    <div class="form-group">
                        <label for="product_bd_received_cost">BD Receive<small class="form-text text-muted float-right">((China Local Delivery*Conversion)+Product
                                Value)</small></label>
                    ...
                    <div class="form-group">
                        <label for="chinaLocalDelivery">China Local Delivery(BDT)<small class="form-text text-muted float-right">(China Local Delivery * Conversion
                                Rate)</small></label>
