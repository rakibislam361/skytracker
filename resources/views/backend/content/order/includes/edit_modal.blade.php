                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="shipped_by" id="shipped_by">
                            <option @if (request('shipped_by', null)=='ship_by_air' ) selected @endif value="ship_by_air">ship_by_air</option>
                            <option @if (request('shipped_by', null)=='ship_by_sea' ) selected @endif value="ship_by_sea">ship_by_sea</option>
                        </select>
                    </div>
                    @endif
