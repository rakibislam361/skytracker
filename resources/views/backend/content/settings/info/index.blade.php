...
@php
$multis=DB::table('infos')->where('is_active',1)->orwhere('is_active',0)->get();
@endphp
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                   <form class="form-horizontal" action="{{ route('admin.setting.info.store') }}" enctype="multipart/form-data" method="POST">  
                   @csrf
    ...
    <div class="col-lg-12">
        ...
        <tbody>
            ...
            <td><img src="{{ asset('/setting/banner/'.$multi->image) }}" style="height: 100px"></td>
                ...
                <td>
                    <a href="/admin/setting/info/edit/{{$multi->id}}" class="btn btn-primary btn-sm editProduct">Edit</a>
