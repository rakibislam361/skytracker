        ...
        <x-slot name="body">
            <div x-data="{userType : '{{ $user->type }}'}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="phone" id="phone" class="form-control" placeholder="{{ __('Phone') }}" value="{{ old('phone') ?? $user->phone }}" maxlength="255" />
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="address" id="address" class="form-control" placeholder="{{ __('Address') }}" value="{{ old('address') ?? $user->address }}" maxlength="255"/>
                    </div>
