                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="productQuantity[]" class="form-control"
                                            value="{{ $booking->productQuantity ?? null }}" placeholder="product quantity">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="customer_name[]" class="form-control"
                                            value="{{ $booking->customer_name ?? null }}" placeholder="customer name">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="customer_phone">Customer Phone</label>
                                        <input type="text" name="customer_phone[]" class="form-control"
                                            value="{{ $booking->customer_phone ?? null }}" placeholder="customer phone">
                                    </div>
                                    <div class="form-group col-md-4">
