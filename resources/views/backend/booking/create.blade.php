                            ...
                            <td>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="carton_number" class="form-control" placeholder="carton number">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="productsTotalCost" class="form-control" placeholder="total Cost(BDT)">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="shipping_number" class="form-control" placeholder="shipping number">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="warehouse_quantity" class="form-control" placeholder="warehouse_quantity">
                                    </div>
                                    <div class="form-group col-md-4">
