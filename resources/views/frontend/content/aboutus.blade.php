      ...
      <div class="col-md-6">
        <div class="panel-group" id="accordion">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapseSix"><i class="fa fa-user"></i> Advanced Customer Service <i class="fa fa-angle-right" style="float:right;" aria-hidden="true"></i></a>
              </h4>
            </div>
