 <div class="card" style="border:0px;">
     ...
     <form action="{{ route('frontend.content.booking') }}" method="post" id="booking" name="booking">
         ...
         <div class="form-row mb-2">
             <div class="col"><input type="text" name="ctnQuantity[]" class="form-control" placeholder="quantity"
                     style="border-radius: 10rem; width: 60%;">
             </div>
         </div>
         <div class="form-row mb-1">Total CBM:</div>
         <div class="form-row mb-2">
             <div class="col"><input type="text" name="totalCbm[]" class="form-control" placeholder="total CBM"
                     style="border-radius: 10rem; width: 60%;">
             </div>
         </div>
         ...
         <div class="form-row mb-2">
             <div class="col"><input type="text" name="productQuantity[]" class="form-control"
                     placeholder="product quantity" style="border-radius: 10rem; width: 60%;">
             </div>
         </div>
         <div class="form-row mb-1">Products Total Cost:</div>
         <div class="form-row mb-2">
             <div class="col"><input type="text" name="productsTotalCost[]" class="form-control"
                     placeholder="total Cost(BDT)" style="border-radius: 10rem; width: 60%;">
             </div>
         </div>
         ...
         <div class="form-row mb-2">
             <div class="col"><input type="text" name="othersProductName[]" class="form-control"
                     placeholder="product name" style="border-radius: 10rem; width: 60%;">
             </div>
         </div>
