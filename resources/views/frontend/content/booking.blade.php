         ...
         <div class="card-body">
             <form action="{{ route('frontend.content.booking') }}" method="post" id="booking" name="booking">
                 ...
                 <div class="form-row mb-2">
                     <div class="col"><input type="date" name="date[]" value="{{ now()->format('Y-m-d') }}" class="form-control" placeholder="approx date" style="border-radius: 10rem;">
                     </div>
                 </div>
                 <div class="form-row mb-1">Product Name (specific):
                 </div>
                 <div class="form-row mb-2">
                     <div class="col"><input type="text" name="othersProductName[]" class="form-control" placeholder="product name" style="border-radius: 10rem;">
                     </div>
                 </div>
                 <div class="form-row mb-1">Carton quantity:</div>
                 <div class="form-row mb-2">
                     <div class="col"><input type="text" name="ctnQuantity[]" class="form-control" placeholder="quantity" style="border-radius: 10rem;">
                     </div>
                 </div>
                 <div class="form-row mb-1">Shipping Mark:</div>
                 <div class="form-row mb-2">
                     <div class="col"><input type="text" name="shipping_mark[]" class="form-control" placeholder="shipping mark" style="border-radius: 10rem;">
                     </div>
                 </div>
                 <div class="form-row mb-1">Product Weight:</div>
                 <div class="form-row mb-2">
                     <div class="col"><input type="text" name="actual_weight[]" class="form-control" placeholder="products weight" style="border-radius: 10rem;">
                     </div>
                 </div>
                 <div class="form-row mb-1">Total CBM:</div>
                 <div class="form-row mb-2">
                     <div class="col"><input type="text" name="totalCbm[]" class="form-control" placeholder="total CBM" style="border-radius: 10rem;">
                     </div>
                 </div>
                 <div class="form-row mb-1">Product Quantity:</div>
                 <div class="form-row mb-2">
                     <div class="col"><input type="text" name="productQuantity[]" class="form-control" placeholder="product quantity" style="border-radius: 10rem;">
                     </div>
                 </div>
                 <div class="form-row mb-1">Products Total Cost:</div>
                 <div class="form-row mb-2">
                     <div class="col"><input type="text" name="productsTotalCost[]" class="form-control" placeholder="total Cost(BDT)" style="border-radius: 10rem;">
                     </div>
                 </div>
                 ...
                 <fieldset>
                     ...
                     <div>
                         <input type="radio" id="ofiice_delivery" name="delivery_method" checked value="ofiice_delivery" />
