<section>
    <div class="slider-form" data-animation="fadeInUpS" data-delay=".9s" style="animation-delay: 0.9s;">
        <form method="GET" action="{{ route('frontend.pages.shippingInformationModal') }}">
            ...
            <div class="col-md-2">
                <input type="text" placeholder="Enter Weight(KG)" tabindex="0" spellcheck="false" data-ms-editor="true" name="weight" id="weight" required>
            </div>
            ...
            <div class="col-md-1"><button data-toggle="modal" data-target="#exampleModalLong" class="btn" tabindex="-1"><i class="flaticon-magnifying-glass"></i></button></div>
