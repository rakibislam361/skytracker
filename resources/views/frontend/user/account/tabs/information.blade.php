<x-forms.patch :action="route('frontend.user.profile.update')">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input type="text" name="phone" class="form-control" placeholder="{{ __('Phone') }}" value="{{ old('phone') ?? $logged_in_user->phone }}" required autofocus autocomplete="phone" />
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <input type="text" name="address" class="form-control" placeholder="{{ __('Address') }}" value="{{ old('address') ?? $logged_in_user->address }}" required autofocus autocomplete="address" />
        </div>
    </div>
